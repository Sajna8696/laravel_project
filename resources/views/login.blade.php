...
<body>
    ...
    <center><b>
    <form  class=" text-light col-md-4" action="{{ route('loginuser') }}" method="POST" >
        @csrf
...
<br>
        ...
        <div class="col-md-8">
          ...
          <div class="input-group col-md-4">
            <input type="password" class="form-control" id="password"name="pass"placeholder="PASSWORD" aria-label="Password" aria-describedby="password-toggle" required>
    ...
    <br>
          ...
          <br>
        {{-- <a type="submit" name="submit" class="btn btn-outline-light">LOGIN  </a> --}}
        <button type="submit" >Login</button>
         <br>
         {{-- {{ route('table') }} --}}
        </form>
        <b> <a href="{{ route('form') }}">NEW REGIRSTRASTION ? CLICK HERE</a></b>
    </b></center>
</body>
</html>
